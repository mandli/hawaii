...
def setplot(plotdata=None):
    ...
    def surge_afteraxes(cd):
        surgeplot.surge_afteraxes(cd, track, plot_track=True,
                                             kwargs={"markersize": 4})

    # Color limits
    surface_limits = [-1.0 + 0.5, 1.0 + 0.5]
    ...
    regions = {"Full Domain": {"xlimits": (clawdata.lower[0], clawdata.upper[0]),
                               ...
                               "figsize": (6.4, 4.8)},
               "Hawaii": {"xlimits": (-161, -154),
                          "ylimits": (15, 23),
                          "figsize": (6.4, 4.8)},
               "Kiholo": {"xlimits": (-156.4, -155.8),
                          "ylimits": (19.7, 20.3),
                          "figsize": (6.4, 4.8)}
              }
    ...
    plotaxes.scaled = True
    plotaxes.xlimits = regions['Kiholo']['xlimits']
    plotaxes.ylimits = regions['Kiholo']['ylimits']
